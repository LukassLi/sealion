...
export default class GameView extends cc.Component {
    ...
    public preBallArr: Array<cc.Prefab> = [];
    ...
    @property({ type: Knife, visible: true, displayName: "刀" })
    public knife: Knife = undefined;

    @property({ type: cc.Node, visible: true, displayName: "刀舞台" })
    public knifeStage: cc.Node = undefined;
    
    @property({ type: cc.Node, visible: true, displayName: "球舞台" })
    public ballStage: cc.Node = undefined;
